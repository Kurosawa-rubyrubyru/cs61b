...
public class IntList {
    ...
    public static IntList dcatenate(IntList A, IntList B) {
        if (A == null) {
            if (B == null) {
                ...
                // A = B.clone();  传入A=null，B！=null时才需要，但是null无法实例化。
                return B;
            }
    ...
    public static IntList reverse(IntList A) {
        ...
        int size = 1;
        IntList goal = new IntList(0, A);
        while (goal.rest.rest != null) {
            goal = goal.rest;
            size += 1;
        }
        int[] nums = new int[size];
        nums[0] = A.first;
        goal = new IntList(0, A);
        int i = 1;
        while (goal.rest.rest != null) {
            nums[i] = goal.rest.rest.first;
            goal = goal.rest;
            i += 1;
        }
        goal = new IntList(0, A);
        i = 1;
        goal.rest.first = nums[size - 1];
        while (goal.rest.rest != null) {
            i += 1;
            goal.rest.rest.first = nums[size - i];
            goal = goal.rest;
        }
        return A;
